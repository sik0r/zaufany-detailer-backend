...
class ResetPasswordController extends AbstractController
{
     ...
     * This might not be used directly if only admin triggers activation,
     * but it's useful for a standard "forgot password" flow later.
     */
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        // Use the sender defined as a parameter or hardcoded here
        $senderEmail = $this->getParameter('app.mail_from'); // Get from parameters
        $senderName = $this->getParameter('app.mail_from_name'); // Add this parameter too
